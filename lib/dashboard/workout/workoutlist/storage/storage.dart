...
class exer {
  static abs() {
    return [
      'lib/assets/gif/exer/plank.gif',
      'lib/assets/gif/exer/plank1.gif',
      'lib/assets/gif/exer/plank2.gif',
      'lib/assets/gif/exer/plank3.gif',
      'lib/assets/gif/exer/plank-walkout.gif',
      'lib/assets/gif/exer/ironcrosses.gif'
    ];
  }
  ...
  static chest() {
    return [
      'lib/assets/gif/exer/pushups.gif',
      'lib/assets/gif/exer/pushupsdecline.gif',
      'lib/assets/gif/exer/pushupincline.gif',
      'lib/assets/gif/exer/pushupdiamond.gif',
      'lib/assets/gif/exer/pushupwide.gif',
      'lib/assets/gif/exer/overhead.gif'
    ];
  }
  ...
  static bottom() {
    return [
      'lib/assets/gif/exer/lunges.gif',
      'lib/assets/gif/exer/calf raises.gif',
      'lib/assets/gif/exer/squat.gif',
      'lib/assets/gif/exer/squat jump.gif',
      'lib/assets/gif/exer/wallsquat.gif',
      'lib/assets/gif/exer/squat2.gif'
    ];
  }
  ...
  static sbottom() {
    return [
      ...
      'Squat Jump',
      'Wall Squat',
      'Quick sessions Squat'
    ];
  }

  static cardio() {
    return [
      'lib/assets/gif/exer/burpee.gif',
      'lib/assets/gif/exer/plankcrawl.gif',
      'lib/assets/gif/exer/side jumping.gif',
      'lib/assets/gif/exer/skipping.gif',
      'lib/assets/gif/exer/squat jump.gif',
      'lib/assets/gif/exer/stair climbing.gif'
    ];
  }
  ...
  static weightloss() {
    return [
      'lib/assets/gif/exer/burpee.gif',
      'lib/assets/gif/exer/lunges.gif',
      'lib/assets/gif/exer/mountainclimbPlank.gif',
      'lib/assets/gif/exer/overhead.gif',
      'lib/assets/gif/exer/skipping.gif',
      'lib/assets/gif/exer/stair climbing.gif'
    ];
  ...
  static repsets(var c) {
    ...
    var sets = 3.0;
    String set = '';
    sets = sets + (Personal_info.intensity % 3);
    set = sets.toInt().toString();
    if (minset.contains(c)) {
      return '1 minute, $set sets';
    }
    if (min3set.contains(c)) {
      return '3 minutes, $set sets';
    }
    if (warmup.contains(c)) {
      return '16 counts, 2 sets';
    } else {
      return '12 Repetition, $set sets';
    }
  }

  static calCal(int i) {
    int pacing = Personal_info.pacing;
    var add = Random().nextDouble() * 10;
    var sets = 3.0;
    sets = sets + (Personal_info.intensity % 3);
    if (i == 1) {
      if(Personal_info.gender == 1){add + 5;}
      return (6 + pacing) * sets + add;
    }

    else if (i == 2) {
      if(Personal_info.gender == 1){add + 5;}
      return (6.5 + pacing) * sets + add;
    }

    else if (i == 3) {
      if(Personal_info.gender == 1){add + 5;}
      return (5.5 + pacing) * sets + add;
    }

    else if (i == 4) {
      if(Personal_info.gender == 1){add + 5;}
      return (7.5 + pacing) * sets + add;
    }

    else if (i == 5) {
      if(Personal_info.gender == 1){add + 5;}
      return (7 + pacing) * sets + add;
    }
  }

  static exerPick(int i) {
    if (i == 1) {
      return abs();
    } else if (i == 2) {
      return chest();
  ...
  static subDesc(var s) {
    ...
    switch (s) {
      ...
      case 'Plank-Walkout':
        handle =
            '1. In standing position, bend over where your hands touch the ground\n'
      ...
      case 'Decline Push Up':
        handle =
            '1. Grab a chair or any object with the same height and then place your foot with the object and your hands on the floor. \n'
      ...
      case 'Incline Push Up':
        handle =
            '1. Grab a chair or any object with the same height and then place your foot on the ground and your hands on the object. \n'
            '2. In a push up position, slowly bend your hands to perform a standard push up\n'
            '3. Push back and return to the starting position';
        break;
      case 'Diamond Push Up':
        handle =
            '1. In a push up position, place your both hands near each other.\n'
      ...
      case 'Wide Push Up':
        handle =
            '1. In a push up position, place your both hands far each other.\n'
      ...
      case 'Calf Raises':
        handle =
            '1. On standing position, rest your feet flat ground and pointing forwards.\n'
      ...
      case 'Wall Squat':
        handle =
            '1. Find a straight wall and then press your back against the wall\n'
      ...
      case 'Plank Crawl':
        handle =
            '1. Assume a push up position then bend your arms so that your forearms are touching the ground.\n'
      ...
      case 'Stair Climbing':
        handle =
            '1. Grab a small chair or find any place that has an elevation.\n'
